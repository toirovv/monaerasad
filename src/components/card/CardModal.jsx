...
const BADGE_STYLES = {
  ...
  Popular: {
    bg: `linear-gradient(135deg, ${ACCENT} 0%, #0FBFA3 100%)`,
    text: "#0A0E14",
  },
};
  ...
  return createPortal(
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-3 sm:top-4 sm:right-4 z-10 w-8 h-8 rounded-full flex items-center justify-center shrink-0"
          style={GLASS_BTN}
        >
        ...
        <div className="p-5 sm:p-6 min-w-0">
          ...
          <p
            className="text-[10px] font-semibold uppercase tracking-[0.12em] mb-1 truncate"
            style={{ color: "#6B7280" }}
          >
            {carModel}
          </p>
          ...
          <div className="flex items-end justify-between gap-3 flex-wrap">
            <div className="min-w-0">
              <div className="flex items-baseline gap-2 flex-wrap">
                {hasDiscount && (
                  <span
                    className="text-sm line-through whitespace-nowrap"
                    style={{ color: "#6B7280" }}
                  >
                    {currency}
                    {oldPrice}
