...
const AboutHero = () => (
  <section className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 pt-[72px] sm:pt-32 pb-8 sm:pb-20">
    ...
    >
      ...
      <h1 className="font-display text-2xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-4 sm:mb-6 leading-tight">
        <span className="text-white">Avtomobil ehtiyot qismlarida </span>
        <span className="gradient-text">ishonchli hamkor</span>
      </h1>
      <p className="text-sm sm:text-lg leading-relaxed font-body" style={{ color: "#9CA3AF" }}>
