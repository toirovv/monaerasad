      ...
      <div className="relative">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 max-w-md mx-auto mb-10">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="ring-pulse flex items-center justify-center gap-2 px-6 py-3.5 rounded-full font-semibold text-[13px] sm:text-sm font-body whitespace-nowrap"
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-full font-semibold text-[13px] sm:text-sm font-body text-white whitespace-nowrap transition-colors duration-200"
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3">
          {[
            ...
            const Icon = b.icon;
            return (
              <motion.div key={b.label} whileHover={{ y: -2 }} className="flex items-center gap-2">
